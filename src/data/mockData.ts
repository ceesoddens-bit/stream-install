...
export const suppliers: Supplier[] = [
  {
    ...
    address: null,
    kvk: null,
    createdAt: '16-09-2023 14:04',
    createdByName: 'Systeem',
    createdByInitials: 'S',
    updatedAt: '06-02-2024 18:37',
...
export const warehouses: Warehouse[] = [
  {
    ...
    name: 'Magazijn',
    subCount: 1,
    createdAt: '07-08-2023 12:23',
    createdByName: 'Systeem',
    createdByInitials: 'S',
    updatedAt: '06-02-2024 18:37',
    updatedByName: 'Simon Bijlsma',
    updatedByInitials: 'SB',
  },
];
...
export const stockOverviewRows: StockOverviewRow[] = [
  {
    id: 'so1',
    artikel: 'Trina Solar Vertex S 430Wp (TRNS-430)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang A / Vak 03 / Plank 2',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 420,
    prijsPerStuk: 85,
  ...
  {
    id: 'so2',
    artikel: 'SolarEdge SE5000H Omvormer (SE-INV-5K)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang B / Vak 01 / Plank 1',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 45,
    prijsPerStuk: 850,
  ...
  {
    id: 'so3',
    artikel: 'ClickFit EVO Dakhaak (CLICK-RD)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang C / Vak 12 / Plank 4',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 1800,
    prijsPerStuk: 6.2,
  ...
  {
    id: 'so4',
    artikel: 'Quatt Hybrid Duo V2 (Q-HYB-V2)',
    magazijn: 'Magazijn Zwolle',
    locatie: 'Gang D / Vak 02 / Plank 1',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 12,
    prijsPerStuk: 3200,
  ...
  {
    id: 'so5',
    artikel: 'AlphaEss Thuisbatterij 10kWh (ESS-BAT-10)',
    magazijn: 'Magazijn Almere',
    locatie: 'Gang A / Vak 09 / Plank 3',
    statusLocatie: 'Vrij',
  ...
  {
    id: 'so6',
    artikel: 'Daikin Emura Airco 3.5kW (DK-AC-12)',
    magazijn: 'Magazijn Almere',
    locatie: 'Gang B / Vak 06 / Plank 2',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 8,
    prijsPerStuk: 1200,
  ...
  {
    id: 'so7',
    artikel: 'Nefit TrendLine HRC30 (NF-CV-9000)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang E / Vak 04 / Plank 1',
    statusLocatie: 'In quarantaine',
  ...
  {
    id: 'so8',
    artikel: 'MC4 Connector set (MC4-SET)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang C / Vak 02 / Plank 5',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 560,
    prijsPerStuk: 1.35,
  ...
  {
    id: 'so9',
    artikel: 'PV-kabel 6mm² rood (PV-6-RED)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang F / Vak 07 / Plank 1',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 1200,
    prijsPerStuk: 0.95,
  ...
  {
    id: 'so10',
    artikel: 'PV-kabel 6mm² zwart (PV-6-BLK)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang F / Vak 07 / Plank 2',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 980,
    prijsPerStuk: 0.95,
  ...
  {
    id: 'so11',
    artikel: 'Schroeven RVS 5x60 (RVS-5X60)',
    magazijn: 'Magazijn Zwolle',
    locatie: 'Gang A / Vak 02 / Plank 4',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 4000,
    prijsPerStuk: 0.08,
  ...
  {
    id: 'so12',
    artikel: 'Montagerail 2.4m (RAIL-24)',
    magazijn: 'Magazijn Almere',
    locatie: 'Buiten / Rek 3',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 220,
    prijsPerStuk: 12.4,
  ...
  {
    id: 'so13',
    artikel: 'Kabelgoot 60x60 (KG-6060)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang D / Vak 10 / Plank 1',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 140,
    prijsPerStuk: 18.75,
  ...
  {
    id: 'so14',
    artikel: 'Aardlekautomaat B16 30mA (ALS-B16)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang B / Vak 11 / Plank 2',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 64,
    prijsPerStuk: 29.9,
  ...
  {
    id: 'so15',
    artikel: 'Kabelschoen set 10-16mm² (KS-1016)',
    magazijn: 'Magazijn Zwolle',
    locatie: 'Gang C / Vak 03 / Plank 3',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 320,
    prijsPerStuk: 0.45,
  ...
  {
    id: 'so16',
    artikel: 'Wartel M20 (WARTEL-M20)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang A / Vak 01 / Plank 5',
    statusLocatie: 'Vrij',
    status: 'Beschikbaar',
    hoeveelheid: 900,
    prijsPerStuk: 0.22,
  ...
  {
    id: 'so17',
    artikel: 'Omvormer montagemateriaal (INV-MOUNT)',
    magazijn: 'Magazijn Almere',
    locatie: 'Gang D / Vak 03 / Plank 1',
    statusLocatie: 'Gereserveerd',
    status: 'Gereserveerd',
    hoeveelheid: 15,
    prijsPerStuk: 24.5,
    wisselkoers: 1,
  ...
  {
    id: 'so18',
    artikel: 'Isolatiemateriaal rol 10m² (ISO-10)',
    magazijn: 'Hoofdmagazijn Lelystad',
    locatie: 'Gang G / Vak 05 / Plank 1',
    statusLocatie: 'Vrij',
    status: 'Besteld',
    hoeveelheid: 24,
    prijsPerStuk: 42.2,
